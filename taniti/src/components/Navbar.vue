...
<template>
  <nav class="bg-teal-800 border-b border-teal-900">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-20 items-center justify-between">
        <RouterLink class="flex shrink-0 items-center" to="/">
          <img class="h-10 w-auto" :src="logo" alt="Taniti" />
          <span class="hidden sm:block text-white text-2xl ml-2 font-normal font-stretch-125% text-shadow-sm">Visit Taniti</span>
        </RouterLink>
